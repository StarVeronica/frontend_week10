...
// let checkButton = document.getElementById("button").value;
...
function createGreet(guestName="Гость") {
...
console.log(`Моему другу сейчас ${calculateAge(thisYear, friendYearOfBirth)} лет`);
...
const myYearOfBirth = 2010;

console.log(`Мне сейчас ${calculateAge(thisYear, myYearOfBirth)} лет`)
...
console.log("Результат: " + powerOfNum(5, 3))
